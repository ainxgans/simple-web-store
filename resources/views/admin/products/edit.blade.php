                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{route('products.update', $product)}}" method="post" class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="description" name="description" type="text" class="mt-1 block w-full" :value="$product->description" required/>
                            <x-input-error class="mt-2" :messages="$errors->get('description')" />
                        </div>

                        <div>
                            <x-input-label for="price" :value="__('Price')" />
                            <x-text-input id="price" name="price" type="number" class="mt-1 block w-full" :value="$product->price" required/>
